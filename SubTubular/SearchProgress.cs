...
public sealed class VideoList
{
    ...
    public enum Status { queued, loading, downloading, preValidated, validated, indexing, searching, indexingAndSearching, searched }
...
/// <summary>Pairs the <paramref name="videoList"/> with the <paramref name="reporter"/>
/// and wraps them for convenient progress reporting.</summary>
